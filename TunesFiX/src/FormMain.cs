...
namespace TunesFiX
{
    ...
    public partial class FormMain : Form, IMainForm
    {
        ...
        internal const int LV_FIELD_TITLE = 0; // 1
        internal const int LV_FIELD_ARTIST = 1; // 1
        internal const int LV_FIELD_ALBUM = 2; // 1
        internal const int LV_FIELD_PERFORMER = 3; // 1
        internal const int LV_FIELD_COMPOSER = 4; // 0
        internal const int LV_FIELD_GENRE = 5; // 0
        internal const int LV_FIELD_PUBLISHER = 6; // 0
        internal const int LV_FIELD_CONDUCTOR = 7; // 0
        internal const int LV_FIELD_YEAR = 8; // 0
        internal const int LV_FIELD_TRACK = 9; // 0
        internal const int LV_FIELD_DURATION = 10; // 1
        internal const int LV_FIELD_COMMENTS = 11; // 0
        internal const int LV_FIELD_LYRICS = 12; // 0
        internal const int LV_FIELD_PATH = 13; // 1

        // things are screwy due to little-endian storage format of an int32
        // so search for "DiagFV" and uncomment the messagebox to get checked item constant to fill in...
        // (Title, Artist, Album are always included)
        internal const Int32 LV_FIELD_INIT = 9231; // bits for fields initially showing
        ...
        private void RegistryRead(bool bReset = false)
        {
            ...
            int iPercent = 50;
            string sRootPath = "";
            Int32 iFieldVisible = LV_FIELD_INIT;
            int iCheckingMode = 1;
